...
jest.mock('../../components/register-form/register-form', () => ({
  RegisterForm: () => (
    <form>
...
describe('RegisterPage', () => {
  test('renders the Navbar, Cover with title, and RegisterForm', () => {
    ...
    expect(screen.getByText("Join UofT’s Secure Marketplace Community Today!")).toBeInTheDocument();
  ...
  test('allows the user to type into all input fields', () => {
    ...
    const phoneInput = screen.getByPlaceholderText('Phone No.') as HTMLInputElement;
    const studentIDInput = screen.getByPlaceholderText('UofT Student ID (for verification)') as HTMLInputElement;
