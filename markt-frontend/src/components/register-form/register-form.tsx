...
const RegisterForm: React.FC = () => {
  ...
  // Helper function to validate password (min 8 characters, at least 1 special character)
  ...
  useEffect(() => {
    ...
    if (!password || !validatePassword(password)) newErrors.password = 'Password must be at least 8 characters long and contain at least one special character';
